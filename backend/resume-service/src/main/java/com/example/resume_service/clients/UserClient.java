...
public class UserClient implements IUserClient {
    ...
    private UserProfileDto getMockUserProfile(String userId) {
        ...
        profile.setFullName("Nguyễn Văn Đa Năng");
        profile.setEmail("danang@email.com");
        profile.setHeadline("Fullstack Developer | Hobbyist Photographer");
        
        // 1. SKILLS: Trộn lẫn Kỹ thuật và Kỹ năng mềm/Không liên quan
        List<SkillDto> skills = Arrays.asList(
            // --- Tech Skills (Quan trọng) ---
            new SkillDto("skill_1", "C#"),
            new SkillDto("skill_2", "MongoDB"),
            new SkillDto("skill_3", "ReactJS"),
            new SkillDto("skill_4", "Docker"),
            new SkillDto("skill_5", "Microservices"),
            
            // --- Noise Skills (Cần bị AI lọc bỏ nếu JD là IT) ---
            new SkillDto("skill_6", "Photoshop"),
            new SkillDto("skill_7", "Nấu ăn"),
            new SkillDto("skill_8", "Pha chế cà phê"),
            new SkillDto("skill_9", "Digital Marketing"),
            new SkillDto("skill_10", "Sales")
        );
        profile.setSkills(skills);
        
        // 2. LANGUAGES
        List<LanguageDto> languages = Arrays.asList(
            new LanguageDto("lang_1", "Tiếng Anh", "IELTS 7.0"),
            new LanguageDto("lang_2", "Tiếng Nhật", "N3"),
            new LanguageDto("lang_3", "Tiếng Pháp", "A1 (Sơ cấp)")
        );
        ...
        List<EducationDto> educations = Arrays.asList(
            new EducationDto(
                ...
                LocalDateTime.of(2018, 9, 1, 0, 0), LocalDateTime.of(2022, 6, 1, 0, 0),
                "GPA: 3.6/4.0"
            ),
