...
Thông tin truy cập (Ports & Credentials)
...
Docker Desktop (Bắt buộc): Tải tại đây
...
Tắt MySQL/XAMPP trên máy.

Hoặc chỉnh sửa docker-compose.yml, đổi cổng host (bên trái dấu :) sang cổng khác. VD: "3309:3306".
